---
title: "Kappa Sigma Mu (KΣM): The Kusama Fratority"
...
> Originally [posted by Gavin](https://hackmd.io/@gavwood/ByEiaFgZ8).
...
New candidate members shall be judged on their ability to provide _Proof-of-Ink_ to existing members, where the _Ink_ shall be a **permanent tattoo** including at least two elements:
...
The identity of the member need _not_ be discernable nor the specific part of the body on which it is placed.
